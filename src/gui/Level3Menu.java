...
public class Level3Menu extends BasicGameState{
	
	Image levelScreen;
	Image level3;
	Image locked;
	
	public static boolean unlockedlvl3 = false;

	public Level3Menu(int levelmenu){
